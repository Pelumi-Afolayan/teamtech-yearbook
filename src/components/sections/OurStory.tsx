      ...
      <div className="mx-auto grid max-w-6xl items-center gap-12 lg:grid-cols-2 lg:gap-20">
        <div>
          ...
          <p className="max-w-xl text-base leading-8 text-[#294b5c] sm:text-lg">
            ...
            every moment shared beyond the chapel walls is a team committed to
            serving with excellence. We are more than the people behind the
            equipment—we are storytellers, problem-solvers and stewards of
            every moment entrusted to us. This is our story, our service and
            our legacy of lights.
          </p>
